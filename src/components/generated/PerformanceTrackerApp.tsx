...
const PerformanceTrackerApp: React.FC = () => {
  ...
  const mockMetrics: MetricData[] = [{
    ...
    target: 50000,
    category: 'Sales',
    mpid: "52358af8-f385-42f8-acbd-27c6205d8c17"
  }, {
    name: 'New Lines',
    actual: 28,
    target: 35,
    category: 'Sales',
    mpid: "b034b659-496f-49aa-84a5-8fb63655fd56"
  }, {
    name: 'Accessories',
    actual: 15,
    target: 20,
    category: 'Attach',
    mpid: "28cf6bd1-d259-412e-b8ce-f4401d0da9a3"
  }, {
    name: 'Insurance',
    actual: 22,
    target: 25,
    category: 'Attach',
    mpid: "f5bf6c96-1758-4ffe-900e-0ef8d4972965"
  }, {
    name: 'NPS Score',
    actual: 8.5,
    target: 9.0,
    category: 'Customer',
    mpid: "56e49024-7b53-44df-b0a0-cf3586975e37"
  }, {
    name: 'Call Quality',
    actual: 92,
    target: 95,
    category: 'Quality',
    mpid: "f27a9ced-cb79-45c9-ae4c-569f4e3cb318"
  }];
  ...
  const renderWelcomeScreen = () => <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4" data-magicpath-id="0" data-magicpath-path="PerformanceTrackerApp.tsx">
      <div className="max-w-md mx-auto pt-20" data-magicpath-id="1" data-magicpath-path="PerformanceTrackerApp.tsx">
        ...
        y: 0
          ...
          <GlassCard className="text-center p-8" data-magicpath-id="3" data-magicpath-path="PerformanceTrackerApp.tsx">
            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full flex items-center justify-center" data-magicpath-id="4" data-magicpath-path="PerformanceTrackerApp.tsx">
            ...
            <p className="text-gray-300" data-magicpath-id="7" data-magicpath-path="PerformanceTrackerApp.tsx">T-Mobile Sales Excellence</p>
          </GlassCard>

          <div className="text-center" data-magicpath-id="8" data-magicpath-path="PerformanceTrackerApp.tsx">
            <p className="text-lg text-gray-200 mb-8" data-magicpath-id="9" data-magicpath-path="PerformanceTrackerApp.tsx">
  ...
  const renderDashboard = () => <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 pb-20" data-magicpath-id="14" data-magicpath-path="PerformanceTrackerApp.tsx">
      <div className="max-w-md mx-auto space-y-4" data-magicpath-id="15" data-magicpath-path="PerformanceTrackerApp.tsx">
        ...
        <div className="grid grid-cols-2 gap-4" data-magicpath-id="19" data-magicpath-path="PerformanceTrackerApp.tsx">
          <GlassCard className="p-4" data-magicpath-id="20" data-magicpath-path="PerformanceTrackerApp.tsx">
            <div className="text-center" data-magicpath-id="21" data-magicpath-path="PerformanceTrackerApp.tsx">
              <Award className="w-8 h-8 text-green-400 mx-auto mb-2" data-magicpath-id="22" data-magicpath-path="PerformanceTrackerApp.tsx" />
              <h3 className="text-sm font-medium text-gray-300 mb-1" data-magicpath-id="23" data-magicpath-path="PerformanceTrackerApp.tsx">Top Performing</h3>
              <p className="text-white font-semibold" data-magicpath-id="24" data-magicpath-path="PerformanceTrackerApp.tsx">{topMetric.name}</p>
              <p className="text-green-400 text-sm" data-magicpath-id="25" data-magicpath-path="PerformanceTrackerApp.tsx">
          ...
          <GlassCard className="p-4" data-magicpath-id="26" data-magicpath-path="PerformanceTrackerApp.tsx">
            <div className="text-center" data-magicpath-id="27" data-magicpath-path="PerformanceTrackerApp.tsx">
              <TrendingUp className="w-8 h-8 text-red-400 mx-auto mb-2" data-magicpath-id="28" data-magicpath-path="PerformanceTrackerApp.tsx" />
              <h3 className="text-sm font-medium text-gray-300 mb-1" data-magicpath-id="29" data-magicpath-path="PerformanceTrackerApp.tsx">Needs Focus</h3>
              ...
              <p className="text-red-400 text-sm" data-magicpath-id="31" data-magicpath-path="PerformanceTrackerApp.tsx">
        ...
        <GlassCard className="p-6" data-magicpath-id="32" data-magicpath-path="PerformanceTrackerApp.tsx">
          ...
          <div className="h-32 bg-gradient-to-r from-pink-500/20 to-purple-600/20 rounded-lg flex items-center justify-center" data-magicpath-id="34" data-magicpath-path="PerformanceTrackerApp.tsx">
            <p className="text-gray-300" data-magicpath-id="35" data-magicpath-path="PerformanceTrackerApp.tsx">Trend Chart Placeholder</p>
          </div>
        </GlassCard>
        ...
        <GlassCard className="p-6" data-magicpath-id="36" data-magicpath-path="PerformanceTrackerApp.tsx">
          <div className="text-center" data-magicpath-id="37" data-magicpath-path="PerformanceTrackerApp.tsx">
            <p className="text-gray-300 italic mb-4" data-magicpath-id="38" data-magicpath-path="PerformanceTrackerApp.tsx">
              "Success is not final, failure is not fatal: it is the courage to continue that counts."
            </p>
            <button onClick={() => setCurrentScreen('metrics')} className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-6 py-2 rounded-lg font-medium" data-magicpath-id="39" data-magicpath-path="PerformanceTrackerApp.tsx">
  ...
  const renderHomeNavigation = () => <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 pb-20" data-magicpath-id="40" data-magicpath-path="PerformanceTrackerApp.tsx">
      <div className="max-w-md mx-auto" data-magicpath-id="41" data-magicpath-path="PerformanceTrackerApp.tsx">
        ...
        <div className="grid grid-cols-2 gap-4" data-magicpath-id="43" data-magicpath-path="PerformanceTrackerApp.tsx">
          ...
          mpid: "7fc88f6a-bc3a-4bfc-bf28-1e15885be4d5"
        }, {
          icon: Target,
          label: 'Daily Goals',
          screen: 'goals' as Screen,
          mpid: "b220fe63-72ac-4ecc-b12e-01869a0bc0c4"
        }, {
          icon: Calendar,
          label: 'Catch-Up Plan',
          screen: 'catchup' as Screen,
          mpid: "73b0f946-94c2-47f9-8b1b-13c5cfe3e6c5"
        }, {
          icon: BarChart3,
          label: 'Shift Tracker',
          screen: 'daily' as Screen,
          mpid: "7d23e722-010e-48fa-82a5-95c792b3c0bb"
        }, {
          icon: TrendingUp,
          label: 'View All Metrics',
          screen: 'metrics' as Screen,
          mpid: "eb053449-dcc6-4c5a-a0f8-61b9c6d8def3"
        }, {
          icon: Award,
          label: 'Trend Insights',
          screen: 'dashboard' as Screen,
          mpid: "a91f34b3-f0dc-4630-ab66-9bb7b1f99353"
          ...
          delay: index * 0.1
              ...
              <GlassCard className="p-6 h-32" data-magicpath-uuid={(item as any)["mpid"] ?? "unsafe"} data-magicpath-id="45" data-magicpath-path="PerformanceTrackerApp.tsx">
                <button onClick={() => setCurrentScreen(item.screen)} className="w-full h-full flex flex-col items-center justify-center space-y-2 text-white hover:text-pink-300 transition-colors" data-magicpath-uuid={(item as any)["mpid"] ?? "unsafe"} data-magicpath-id="46" data-magicpath-path="PerformanceTrackerApp.tsx">
  ...
  const renderMetrics = () => <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 pb-20" data-magicpath-id="49" data-magicpath-path="PerformanceTrackerApp.tsx">
          ...
          return <GlassCard key={metric.name} className="p-4" data-magicpath-uuid={(metric as any)["mpid"] ?? "unsafe"} data-magicpath-id="56" data-magicpath-path="PerformanceTrackerApp.tsx">
                    <div className="flex items-center justify-between" data-magicpath-uuid={(metric as any)["mpid"] ?? "unsafe"} data-magicpath-id="57" data-magicpath-path="PerformanceTrackerApp.tsx">
                      <div className="flex-1" data-magicpath-uuid={(metric as any)["mpid"] ?? "unsafe"} data-magicpath-id="58" data-magicpath-path="PerformanceTrackerApp.tsx">
                        ...
                        <p className="text-gray-300 text-sm" data-magicpath-uuid={(metric as any)["mpid"] ?? "unsafe"} data-magicpath-field="actual:unknown,target:unknown" data-magicpath-id="60" data-magicpath-path="PerformanceTrackerApp.tsx">
                          {metric.actual} / {metric.target}
                        </p>
                        <p className="text-xs text-gray-400 mt-1" data-magicpath-uuid={(metric as any)["mpid"] ?? "unsafe"} data-magicpath-id="61" data-magicpath-path="PerformanceTrackerApp.tsx">
  ...
  const renderUpload = () => <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 pb-20" data-magicpath-id="63" data-magicpath-path="PerformanceTrackerApp.tsx">
      <div className="max-w-md mx-auto space-y-6" data-magicpath-id="64" data-magicpath-path="PerformanceTrackerApp.tsx">
        ...
        <GlassCard className="p-6" data-magicpath-id="66" data-magicpath-path="PerformanceTrackerApp.tsx">
          <div className="text-center" data-magicpath-id="67" data-magicpath-path="PerformanceTrackerApp.tsx">
            ...
            <label htmlFor="image-upload" className="cursor-pointer block p-8 border-2 border-dashed border-gray-400 rounded-lg hover:border-pink-400 transition-colors" data-magicpath-id="69" data-magicpath-path="PerformanceTrackerApp.tsx">
              <Camera className="w-12 h-12 text-gray-400 mx-auto mb-4" />
              <p className="text-gray-300" data-magicpath-id="70" data-magicpath-path="PerformanceTrackerApp.tsx">Tap to upload report image</p>
            </label>
          </div>
        </GlassCard>
        ...
        {uploadedImage && <GlassCard className="p-4" data-magicpath-id="71" data-magicpath-path="PerformanceTrackerApp.tsx">
            ...
            <button onClick={handleExtractMetrics} disabled={isExtracting} className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3 rounded-lg font-medium disabled:opacity-50" data-magicpath-id="73" data-magicpath-path="PerformanceTrackerApp.tsx">
        ...
        {isExtracting && <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50" data-magicpath-id="74" data-magicpath-path="PerformanceTrackerApp.tsx">
            <GlassCard className="p-8 text-center" data-magicpath-id="75" data-magicpath-path="PerformanceTrackerApp.tsx">
              <div className="animate-spin w-8 h-8 border-2 border-pink-500 border-t-transparent rounded-full mx-auto mb-4" data-magicpath-id="76" data-magicpath-path="PerformanceTrackerApp.tsx"></div>
