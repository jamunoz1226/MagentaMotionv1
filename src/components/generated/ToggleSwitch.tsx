...
const ToggleSwitch: React.FC<ToggleSwitchProps> = ({
  ...
  return <div className={cn('flex items-center space-x-3', className)}>
      ...
      {rightLabel && <span className={cn('font-medium transition-colors duration-200', sizes.text, checked ? 'text-white' : 'text-gray-400')}>
          {rightLabel}
        </span>}
    </div>;
};
